      ...
      <div className="card-body">
        <div className="flex ">
          ...
          <div className="ml-5 mt-2">
            <strong>
              {" "}
              <p className="m-0">Hotel Yellow Pagoda</p>
            </strong>

            <p>Hotel in Pokhara</p>

            <p>
              Set in Pokhara, 300 metres from Fewa Lake,Hotel Portland offers
              air-conditioned rooms and a bar.
            </p>
          </div>
        </div>
        ...
        <div className="card-actions">
          ...
          <button className="btn btn-ghost hover:bg-blue-500 hover:text-white">
            Deny
          </button>
        </div>
      </div>
